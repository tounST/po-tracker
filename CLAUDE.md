...
- **Cache version ปัจจุบัน**: `po-tracker-v52` — bump ทุกครั้งที่ modify cached files (ตอนนี้ cache: index / po-mobile / po-desktop / **erp** / **stock**)
...
| **ให้พนักงาน (staff) เปิดหน้าสต๊อกได้** | ✅ **เสร็จ 2026-09-25** — ธงใหม่ `viewStock` · staff/manager เข้าตรงจากปุ่มในหน้า PO · ERP เหลือ admin/supervisor/office · ค้างคำถาม: ซ่อนมูลค่าบาทจาก staff ไหม |
